  ...
  <header class="blog-header lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="#comentarios">ScaleNews</a>
      </div>
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 rounded text-bg-dark">
    <div class="col-md-6 px-0">
      ...
      <p class="lead my-3">Essa notícia é muito interessante...</p>
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        @foreach ($notices as $notice)
            <a href="/noticia/{{$notice->id}}"><div class="alert alert-secondary" role="alert">
            {{$notice->title}} | {{$notice->comments->count()}} Comentário(s)
            </div>
            </a>
        @endforeach
